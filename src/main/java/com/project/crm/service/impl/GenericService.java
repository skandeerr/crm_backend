...
import com.project.crm.persistence.dao.IGenericDao;
import com.project.crm.service.IGenericService;
...
/*    @Override
    public List<T> findByIdIn(Iterable<Long> ids) {
        List<T> returnedList;
    ...
    public Set<T> findByIdIn(Set<Long> set) {
        Set<T> returnedSet;
        returnedSet = (Set<T>) genericDao.findByIdIn(set);
        return returnedSet;
    }
